...
(function() {
     ...
     * VERSÃO 1.9.2
     * - CORREÇÃO: Resolvido o problema onde os botões não reapareciam em uma nova consulta.
    ...
    const observer = new MutationObserver(function (mutations, obs) {
        if (document.getElementById('tabela_wrapper')) {
            ...
            // CORREÇÃO: A linha abaixo foi comentada para que o script continue
            // funcionando mesmo quando a tabela é recarregada com novos dados.
            // obs.disconnect();
        }
    });
